# packages/libraries installed:                                                     installation status:

# - pip install flask                                                               (done!)
# - pip install pandas numpy (both for data manipulation)                           (both done!)
# - pip install torch tensorflow (both used for working on neural networks,
#                                                   such as image recognition)      (both done!)

# - pip install opencv-python (for image processing)                                (done!)
# - pip install keras                                                               (done!)
# - pip install matplotlib seaborn (both used for visualising data,
#                               especially when working on images or features)      (done!)

# - pip install scikit-learn scapy (both used for securing the code and app)        (both done!)
# - pip install python-dotenv                                                       (done!)
# - pip install werkzeug                                                            (done!)
